...
- **app-building.md** — Full app-building reference: architecture (packages, client/server/events), development loop, event handlers, deployment patterns, the Bkper Platform, and self-hosted alternatives. Load this for scaffolding apps, understanding app structure, or debugging the dev/build/deploy lifecycle.
